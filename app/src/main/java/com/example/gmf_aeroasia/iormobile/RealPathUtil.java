...
class RealPathUtil {
    ...
    public static String getRealPathFromURI_API19(Context context, Uri photoUri) {
        ...
        if (DocumentsContract.isDocumentUri(context, photoUri)) {
            ...
            path = getDataColumn(context, photoUri, (String)null, (String[])null);
    ...
    public static String getRealPathFromURI_API11to18(Context context, Uri contentUri) {
        Log.d("OpenFile", "API 11 to 18");
        String[] proj = new String[]{"_data"};
        String result = null;
        CursorLoader cursorLoader = new CursorLoader(context, contentUri, proj, (String)null, (String[])null, (String)null);
